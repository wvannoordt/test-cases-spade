...
int main(int argc, char** argv)
{
    ...
    //to link PTL without the compiler wrapper
    //hitting a segfault at some stage.
    ...
    const real_t xmax             = 2.0*spade::consts::pi;
    const real_t ymin             = 0.0;
    const real_t ymax             = 2.0*spade::consts::pi;
    const real_t zmin             = 0.0;
    const real_t zmax             = 2.0*spade::consts::pi;
    const std::string init_file   = "none";
    const bool do_output          = true;
    const bool output_rhs         = false;
    
    const real_t u0               = 1.0;
    const real_t rho0             = 1.0;
    const real_t p0               = 10.0;
    const real_t T0               = 300.0;
    const real_t mach             = 0.08;
    const real_t reynolds         = 1600;
